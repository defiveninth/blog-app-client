...
import { useCategories } from '@/actions/categories.actions'
import { useCreatePost } from '@/actions/post.actions'
...
export default function CreatePostForm() {
	...
	const { categories, isLoading: loadingCategories, isError: categoriesError } = useCategories()
			...
			<div>
				...
				{loadingCategories ? (
					...
					<select
						id="category"
						value={category}
						onChange={(e) => setCategory(e.target.value)} // now stores ID
